...
ReturnType means the method has return value or not. If the method does not have return type, then it is said as "void". 
...
The methodName is followed by () brackets. Within these round brackets,the parameters are passed. When we use multiple data type parameters, we use commas in the () brackets. 
